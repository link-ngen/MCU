...
static void ssd1306_DrawFastVLine(uint8_t x, uint8_t y, uint8_t h,
		SSD1306_COLOR color)
{
	ssd1306_Line(x, y, x, y + h - 1, color);
}

static void ssd1306_DrawFastHLine(uint8_t x, uint8_t y, uint8_t w,
		SSD1306_COLOR color)
{
	ssd1306_Line(x, y, x + w - 1, y, color);
}

static void ssd1306_FillCircleHelper(uint8_t x0, uint8_t y0, uint8_t r,
...
SSD1306_VERTEX ssd1306_GetBasisCoordinate(int8_t transx, int8_t transy)
{
	SSD1306_VERTEX loc_vertex;
	loc_vertex.x = transx + SSD1306.dx;
	loc_vertex.y = transy + SSD1306.dy;
	return loc_vertex;
}

void ssd1306_Translate(uint8_t x, uint8_t y)
{
	SSD1306.dx = x;
	SSD1306.dy = y;
}
		...
		SSD1306_COLOR color)
{
	...
	{
		ssd1306_DrawFastVLine(i, y1, h, color);
	}
}
...
void ssd1306_FillTriangle(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1,
		uint8_t x2, uint8_t y2, SSD1306_COLOR color)
{
	int16_t a, b, y, last;
...
void ssd1306_DrawBitMap(uint8_t x, uint8_t y, const uint8_t bitmap[], uint8_t w,
